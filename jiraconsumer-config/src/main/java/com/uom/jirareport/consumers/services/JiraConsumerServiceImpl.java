...
public class JiraConsumerServiceImpl implements JiraConsumerService {
    ...
    @Override
    public List<ProjectDTO> getDomainProjectsFromJira() throws Exception {
...
//
//    @Override
//    public DataBugsReportDTO getBugsCountPerMonth(String projectKey) throws Exception {
...
//
//        prepareArguments(jiraConsumer.get().getJiraRestUrl()+jqlQuery);
//        executeJiraHttpRequest(REQUEST, argumentsForRequest);
//
//        JSONObject jsonObject = new JSONObject(oAuthClient.getHttpResponse().parseAsString());
//
